...
# Options:模块开关
###############################################################################
set(MODULE_COMM                         ON           CACHE BOOL         "build comm"                                            FORCE)
...
set(MODULE_IOGATEWAY                    ON           CACHE BOOL         "build framework iogateway"                             FORCE)
...
set(MODULE_SERVICE_CAN                  OFF          CACHE BOOL         "build framework service communication can"             FORCE)
...
set(MODULE_ADAPTOR_CAN                  OFF          CACHE BOOL         "build framework can adapter"                           FORCE)
...
set(MODULE_CAN                          OFF          CACHE BOOL         "build spaceos can "                                    FORCE)
...
set(MODULE_SCENEMANAGE                  ON           CACHE BOOL         "build perception datafusion scenemanager"              FORCE)
...
set(MODULE_SP_PK_SONARPROC              ON           CACHE BOOL         "build detection sonar sonarproc"                       FORCE)
...
set(MODULE_VRU_PRODUCER                 OFF          CACHE BOOL         "build localization odom vru_producer"                  FORCE)
set(MODULE_VRU_WE_SAVER                 OFF          CACHE BOOL         "build localization odom vru_we_saver"                  FORCE)
set(MODULE_VRU_WHEELENCODER_PACKER      OFF          CACHE BOOL         "build localization odom vru_wheelencoder_packer"       FORCE)
set(MODULE_YAWRATER_PRODUCER            OFF          CACHE BOOL         "build localization odom yawrater_producer"             FORCE)
...
set(MODULE_SP_PK_HASTAR                 ON           CACHE BOOL         "build SP_PK_HASTAR"                                    FORCE)
set(MODULE_LIB_HASTAR                   OFF          CACHE BOOL         "build lib hastar"                                      FORCE)
set(MODULE_AVP_LOCALPLANNER             ON           CACHE BOOL         "build avp_localplanner"                                FORCE)

##############################   v2x   ##############################
set(MODULE_NETWORK_CONNECTOR            OFF          CACHE BOOL         "build network_connector"                               FORCE)
...
set(MODULE_SP_AUTOPILOT_INFS_GCC        ON           CACHE BOOL        "build spaceos infs"                                     FORCE)
set(MODULE_LAUNCHER_LINUX_GCC           ON           CACHE BOOL        "build spaceos launcher"                                 FORCE)
