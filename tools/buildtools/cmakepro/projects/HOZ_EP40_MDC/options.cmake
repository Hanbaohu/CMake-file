...
set(MODULE_SERVICE_DIAGNOSTIC           ON           CACHE BOOL         "build framework service diagnostic"                    FORCE)
...
set(MODULE_SENSORFUSION_FREESPACE       ON           CACHE BOOL         "build perception datafusion sensorfusion_freespace"    FORCE)
...
set(MODULE_SENSORFUSION_OD              ON           CACHE BOOL         "build perception datafusion sensorfusion_od"           FORCE)
...
set(MODULE_SP_PK_SONARPROC              ON           CACHE BOOL         "build detection sonar proc"                            FORCE)
set(MODULE_SP_PK_SONARDETECT            ON           CACHE BOOL         "build detection sonar detect"                          FORCE)
...
set(MODULE_REVERSING_ASSISTANT          ON           CACHE BOOL         "build localization reversing assistant"                FORCE)
...
##############################   decision   ##############################
set(MODULE_AVP_BEHAVIORDECISION         OFF           CACHE BOOL         "build avp_behaviorDecision"                            FORCE)
set(MODULE_SP_PK_OBJAVOID               ON           CACHE BOOL         "build SP_PK_ObjAvoid"                                  FORCE)
set(MODULE_SP_PK_PAS                    OFF           CACHE BOOL         "build SP_PK_Pas"                                       FORCE)
...
##############################   planning   ##############################
set(MODULE_AVP_PATHFOLLOW               OFF           CACHE BOOL         "build avp_pathfollow"                                  FORCE)
...
set(MODULE_PLANNING                     OFF           CACHE BOOL         "build planning"                                        FORCE)
set(MODULE_ROUTING                      OFF           CACHE BOOL         "build routing"                                         FORCE)
...
##############################   control   ##############################
set(MODULE_VEHICLECONTROL_ES6           OFF           CACHE BOOL         "build vehiclecontrol_es6"                              FORCE)
...
set(MODULE_EOL_HORZON_EP40              ON            CACHE BOOL         "build eol ep40"                                       FORCE)
