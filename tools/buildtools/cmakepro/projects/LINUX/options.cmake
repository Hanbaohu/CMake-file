...
set(MODULE_SPACEMAP                     OFF           CACHE BOOL         "build map spacemap"                                    FORCE)
...
set(MODULE_LIB_HASTAR                   ON          CACHE BOOL         "build lib hastar"                                      FORCE)
...
set(MODULE_OBU_ADAPTOR                  ON           CACHE BOOL         "build obu_connector"                                   FORCE)

##############################   hmi   ##############################
set(MODULE_APA_DEBUG_MONITOR            OFF           CACHE BOOL        "build apa_debug_monitor"                               FORCE)
...
set(MODULE_HMI_P7                       OFF           CACHE BOOL         "build hmi_p7"                                          FORCE)
...
set(MODULE_LIDAR_HMI                    ON           CACHE BOOL         "build lidar hmi"                                       FORCE)

##############################   control   ##############################
set(MODULE_VEHICLECONTROL_ES6           ON           CACHE BOOL         "build vehiclecontrol_es6"                              FORCE)
set(MODULE_REMOTE_CONTROL_CONNECTOR     ON           CACHE BOOL         "build remote control connector "                       FORCE)
...
set(MODULE_SP_AUTOPILOT_INFS_GCC        OFF           CACHE BOOL        "build spaceos infs"                                     FORCE)
...
if (WIN32)
    ...
    set(MODULE_HMI_SPACEVIEW                OFF          CACHE BOOL         "build hmi spaceview"                                   FORCE)
    set(MODULE_DISPLAY                      ON           CACHE BOOL         "build display"                                         FORCE)
    set(MODULE_PIX_LIDAR_DRIVER             ON           CACHE BOOL         "build pix lidar driver"                                FORCE)
    set(MODULE_LIDARPROC_PIX                ON           CACHE BOOL         "build lidar proc pix"                                  FORCE)
    set(MODULE_LIDAR_PLAYBACK               ON           CACHE BOOL         "build lidar playback"                                  FORCE)
    set(MODULE_LIDAR_POINTCLOUD_VIEWER      ON           CACHE BOOL         "build lidar pointcloud viewer"                         FORCE)
    set(MODULE_LIDARFREESPACE               ON          CACHE BOOL          "build detection lidar LidarFreespace"                  FORCE)
    set(MODULE_MONITOR                      ON           CACHE BOOL         "build monitor"                                         FORCE)
    set(MODULE_LIDAR_GRID                   ON            CACHE BOOL         "build lidar grid"                                     FORCE)
    set(MODULE_LIDARLOCATOR                 OFF           CACHE BOOL         "build detection lidar LidarLocator"                    FORCE)
elseif (UNIX)
    set(MODULE_MULTIPROCESSTRANSPORT        ON           CACHE BOOL         "build framework multiprocesstransport"                FORCE)
    set(MODULE_HMI_SPACEVIEW                OFF           CACHE BOOL         "build hmi spaceview"                                  FORCE)
    set(MODULE_DISPLAY                      OFF           CACHE BOOL         "build display"                                        FORCE)
    set(MODULE_CAPTURE                      ON            CACHE BOOL         "build capture"                                        FORCE)
    set(MODULE_PIX_LIDAR_DRIVER             OFF           CACHE BOOL         "build pix lidar driver"                                FORCE)
    set(MODULE_LIDARPROC_PIX                OFF            CACHE BOOL         "build lidar proc pix"                                  FORCE)
    set(MODULE_LIDAR_PLAYBACK               OFF           CACHE BOOL         "build lidar playback"                                  FORCE)
    set(MODULE_LIDAR_POINTCLOUD_VIEWER      OFF           CACHE BOOL         "build lidar pointcloud viewer"                         FORCE)
    set(MODULE_LIDARFREESPACE               OFF           CACHE BOOL         "build detection lidar LidarFreespace"                  FORCE)
    set(MODULE_MONITOR                      ON            CACHE BOOL         "build monitor"                                         FORCE)
    set(MODULE_LIDAR_GRID                   OFF            CACHE BOOL         "build lidar grid"                                      FORCE)
    set(MODULE_LIDARLOCATOR                 OFF            CACHE BOOL         "build detection lidar LidarLocator"                    FORCE)
